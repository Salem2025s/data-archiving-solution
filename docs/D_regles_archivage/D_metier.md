...
- **Signal de purge manquant** : en périmètre Oracle-only, la source ne fournit pas de journal de purge réel ; l'archivabilité repose sur les seuls signaux dérivés des métadonnées (volumétrie, âge, lignage).
